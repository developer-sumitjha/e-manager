        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h5>Edit Subscription Plan: {{ $plan->name }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('super.plans.update', $plan) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price_monthly" class="form-control @error('price_monthly') is-invalid @enderror" 
                                       value="{{ old('price_monthly', $plan->price_monthly) }}" min="0" step="0.01" required>
                                @error('price_monthly')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price_yearly" class="form-control" 
                                       value="{{ old('price_yearly', $plan->price_yearly) }}" min="0" step="0.01">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="number" name="max_orders_per_month" class="form-control" 
                                       value="{{ old('max_orders_per_month', $plan->max_orders_per_month) }}" min="0" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Max Products *</label>
                                <input type="number" name="max_products" class="form-control" 
                                       value="{{ old('max_products', $plan->max_products) }}" min="0" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Max Users *</label>
                                <input type="number" name="max_users" class="form-control" 
                                       value="{{ old('max_users', $plan->max_users) }}" min="0" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Storage (GB) *</label>
                                <input type="number" name="max_storage_gb" class="form-control" 
                                       value="{{ old('max_storage_gb', $plan->max_storage_gb) }}" min="0" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="trial_days" class="form-control" 
                                       value="{{ old('trial_days', $plan->trial_days) }}" min="0" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="has_inventory" value="1" 
                                           {{ old('has_inventory', $plan->has_inventory) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="has_manual_delivery" value="1"
                                           {{ old('has_manual_delivery', $plan->has_manual_delivery) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="has_logistics_integration" value="1"
                                           {{ old('has_logistics_integration', $plan->has_logistics_integration) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="has_accounting" value="1"
                                           {{ old('has_accounting', $plan->has_accounting) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="has_analytics" value="1"
                                           {{ old('has_analytics', $plan->has_analytics) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="has_multi_user" value="1"
                                           {{ old('has_multi_user', $plan->has_multi_user) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="has_custom_domain" value="1"
                                           {{ old('has_custom_domain', $plan->has_custom_domain) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="has_priority_support" value="1"
                                           {{ old('has_priority_support', $plan->has_priority_support) ? 'checked' : '' }}>
                        ...
                        <div class="alert alert-warning">
                            ...
                            This plan has {{ $plan->tenants_count }} active tenant(s). Changes will not affect existing subscriptions.
                        </div>
                        @endif
