...
<body>
    ...
    <div class="main-content">
        ...
        <div class="settings-tabs">
            <a href="{{ route('super.settings.general') }}" class="tab-link active">
            ...
            <form action="{{ route('super.settings.save') }}" method="POST">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="platform_name" class="form-control" value="{{ $settings['platform_name'] ?? 'E-Manager' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Support Email</label>
                        <input type="email" name="support_email" class="form-control" value="{{ $settings['support_email'] ?? 'support@e-manager.com' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 mb-3">
                        <label class="form-check-label">
                            <input type="checkbox" name="auto_approve_vendors" class="form-check-input" {{ ($settings['auto_approve_vendors'] ?? false) ? 'checked' : '' }}>
                            Auto-approve new vendors
                        </label>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-check-label">
                            <input type="checkbox" name="require_email_verification" class="form-check-input" {{ ($settings['require_email_verification'] ?? true) ? 'checked' : '' }}>
                            Require email verification
                        </label>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Default Trial Period (days)</label>
                        <input type="number" name="default_trial_days" class="form-control" value="{{ $settings['default_trial_days'] ?? 14 }}">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="mb-3">
                    <label class="form-check-label">
                        <input type="checkbox" name="maintenance_mode" class="form-check-input" {{ ($settings['maintenance_mode'] ?? false) ? 'checked' : '' }}>
