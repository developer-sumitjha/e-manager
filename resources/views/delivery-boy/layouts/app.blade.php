...
<head>
    ...
    <title>@yield('title', 'Delivery Boy Dashboard') - E-Manager</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="user-profile">
            <div class="profile-info">
                <img src="{{ Auth::guard('delivery_boy')->user()->profile_photo ? asset('storage/' . Auth::guard('delivery_boy')->user()->profile_photo) : 'https://via.placeholder.com/48' }}" alt="Profile">
                <div class="info">
                    <h6>{{ Auth::guard('delivery_boy')->user()->name }}</h6>
                    <p>{{ Auth::guard('delivery_boy')->user()->delivery_boy_id }}</p>
                </div>
            </div>
        </div>
    </aside>
    ...
    <!-- Logout Form -->
    <form id="logout-form" action="{{ route('delivery-boy.logout') }}" method="POST" style="display: none;">
        @csrf
    </form>
