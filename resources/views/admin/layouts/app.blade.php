        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="{{ route('admin.pending-orders.index') }}" class="nav-link {{ request()->routeIs('admin.pending-orders.index') || request()->routeIs('admin.pending-orders.create') || request()->routeIs('admin.pending-orders.edit') || request()->routeIs('admin.pending-orders.show') || request()->routeIs('admin.pending-orders.create-bulk') ? 'active' : '' }}">
                    ...
                    <div class="nav-item">
                        <a href="{{ route('admin.pending-orders.trash') }}" class="nav-link {{ request()->routeIs('admin.pending-orders.trash') ? 'active' : '' }}">
