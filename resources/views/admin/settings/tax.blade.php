...
@section('settings-title', 'Tax & Currency Settings')
@section('settings-description', 'Setup tax rates, currency settings, and pricing options')
@section('settings-icon', 'percentage')
