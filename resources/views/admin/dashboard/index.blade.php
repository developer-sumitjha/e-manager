        ...
        <div class="col-lg-8">
            <div class="hero-content">
                ...
                <div class="hero-stats">
                    <div class="hero-stat">
                        <span class="hero-stat-value" data-count="{{ $stats['total_orders'] ?? 0 }}">0</span>
                        <span class="hero-stat-label">Total Orders</span>
                    </div>
                    <div class="hero-stat">
                        <span class="hero-stat-value" data-count="{{ $stats['total_revenue'] ?? 0 }}">Rs. 0</span>
                        <span class="hero-stat-label">Revenue</span>
                    </div>
                    <div class="hero-stat">
                        <span class="hero-stat-value" data-count="{{ $stats['total_customers'] ?? 0 }}">0</span>
