...
@section('title', 'Comments & Communication')
@section('page-title', 'Comments & Communication')
                ...
                <div class="comment-stats">
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <h3>{{ number_format($commentStats['total_comments']) }}</h3>
                            <p>Total Comments</p>
                        </div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <h3>{{ number_format($commentStats['comments_today']) }}</h3>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <h3>{{ number_format($commentStats['unread_comments']) }}</h3>
                            <p>Unread Comments</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="shipment-item">
                        <div class="shipment-header">
                            <div class="shipment-info">
                                <h5>{{ $shipment->order->order_number ?? 'N/A' }}</h5>
                                <div class="shipment-meta">
                                    <span><i class="fas fa-user"></i> {{ $shipment->order->user->name ?? 'N/A' }}</span>
                                    <span><i class="fas fa-phone"></i> {{ $shipment->order->user->phone ?? 'N/A' }}</span>
                                    <span><i class="fas fa-clock"></i> {{ $shipment->created_at->diffForHumans() }}</span>
                                </div>
                            </div>
                            <div class="d-flex gap-2">
                                <span class="status-badge {{ strtolower(str_replace(' ', '-', $shipment->last_delivery_status)) }}">
                                    {{ $shipment->last_delivery_status ?? 'Unknown' }}
                                </span>
                        ...
                        <div class="comments-section">
                            <div class="add-comment-form">
                                <form class="comment-input-group" onsubmit="addComment(event, {{ $shipment->id }})">
                                    @csrf
                            ...
                            <div class="comments-list">
                                ...
                                <div class="comment-item">
                                    <div class="comment-header">
                                        ...
                                        <span class="comment-meta">
                                            <i class="fas fa-user"></i> Admin • {{ now()->subHours(2)->diffForHumans() }}
                                        </span>
                                    </div>
                                ...
                                <div class="comment-item">
                                    <div class="comment-header">
                                        ...
                                        <span class="comment-meta">
                                            <i class="fas fa-user"></i> System • {{ now()->subHours(1)->diffForHumans() }}
                                        </span>
                                    </div>
