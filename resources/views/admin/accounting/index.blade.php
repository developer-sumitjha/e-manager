...
@section('title', 'Financial Command Center')
@section('page-title', 'Financial Command Center')
...
<div class="financial-command-center">
    <div class="command-center-header">
        ...
        <div class="command-center-actions">
            <a href="{{ route('admin.accounting.export-reports') }}" class="export-btn">
...
<div class="sub-nav-tabs">
    <a href="{{ route('admin.accounting.index', ['tab' => 'dashboard']) }}" class="sub-nav-tab {{ $activeTab == 'dashboard' ? 'active' : '' }}">
        <i class="fas fa-tachometer-alt icon"></i>
        <span>Dashboard</span>
    </a>
    <a href="{{ route('admin.accounting.accounts') }}" class="sub-nav-tab">
        <i class="fas fa-wallet icon"></i>
        <span>Accounts</span>
    </a>
    <a href="{{ route('admin.accounting.sales') }}" class="sub-nav-tab">
        <i class="fas fa-chart-line icon"></i>
        <span>Sales</span>
    </a>
    <a href="{{ route('admin.accounting.purchases') }}" class="sub-nav-tab">
        <i class="fas fa-shopping-cart icon"></i>
        <span>Purchases</span>
    </a>
    <a href="{{ route('admin.accounting.expenses') }}" class="sub-nav-tab">
        <i class="fas fa-receipt icon"></i>
        <span>Expenses</span>
    </a>
    <a href="{{ route('admin.accounting.ledger') }}" class="sub-nav-tab">
        <i class="fas fa-book icon"></i>
        <span>Ledger</span>
    </a>
    <a href="{{ route('admin.accounting.payments') }}" class="sub-nav-tab">
        <i class="fas fa-credit-card icon"></i>
        <span>Payments</span>
    </a>
    <a href="{{ route('admin.accounting.reports') }}" class="sub-nav-tab">
...
<div class="financial-metrics-grid">
    <div class="metric-card">
        ...
        <div class="metric-value">Rs. {{ number_format($metrics['total_revenue'], 2) }}</div>
    ...
    <div class="metric-card">
        ...
        <div class="metric-value">Rs. {{ number_format($metrics['total_expenses'], 2) }}</div>
        <div class="metric-subtitle">This month</div>
    ...
    <div class="metric-card">
        ...
        <div class="metric-value">Rs. {{ number_format($metrics['net_income'], 2) }}</div>
        <div class="metric-subtitle">Profit margin</div>
        <div class="metric-trend {{ $metrics['net_income'] >= 0 ? 'trend-up' : 'trend-down' }}">
            <i class="fas fa-{{ $metrics['net_income'] >= 0 ? 'arrow-up' : 'arrow-down' }}"></i>
        </div>
    </div>
    ...
    <div class="metric-card">
        ...
        <div class="metric-value">Rs. {{ number_format($metrics['cash_balance'], 2) }}</div>
...
<div class="modal fade" id="quickEntryModal" tabindex="-1" aria-labelledby="quickEntryModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.accounting.quick-entry') }}" method="POST">
                @csrf
