    ...
    <form id="homepageForm">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="show_hero_slides" id="showHeroSlides" {{ ($settings->additional_settings['show_hero_slides'] ?? false) ? 'checked' : '' }}>
            ...
            <div id="slidesContainer">
                ...
                <div class="slide-item mb-4" data-slide-index="{{ $index }}">
                        ...
                        <div class="card-header" style="background: #ffffff; border-bottom: 1px solid #000000; padding: 1rem 1.5rem;">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="mb-0" style="font-weight: 600; color: #000000;">
                                    <i class="fas fa-sliders-h"></i> Slide {{ $index + 1 }}
                                </h5>
                                <button type="button" class="btn btn-sm" onclick="removeSlide({{ $index }})" style="color: #000000; border: 1px solid #000000; background: #ffffff;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control slide-heading" name="slides[{{ $index }}][heading]" value="{{ $slide['heading'] ?? '' }}" placeholder="Enter heading">
                                    </div>
                                    
                                    <div class="form-group mb-3">
                                        <label class="form-label">Subheading</label>
                                        <textarea class="form-control slide-subheading" name="slides[{{ $index }}][subheading]" rows="3" placeholder="Enter subheading">{{ $slide['subheading'] ?? '' }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="color-picker-wrapper">
                                            ...
                                            <div class="color-preview slide-bg-color-preview" style="background-color: {{ $slide['background_color'] ?? '#ffffff' }};"></div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="color-picker-wrapper">
                                            <input type="color" class="form-control color-input slide-text-color" name="slides[{{ $index }}][text_color]" value="{{ $slide['text_color'] ?? '#000000' }}" style="width: 80px; height: 45px; padding: 0; border: 1px solid #000000; border-radius: 8px; cursor: pointer;">
                                            <div class="color-preview slide-text-color-preview" style="background-color: {{ $slide['text_color'] ?? '#000000' }};"></div>
                                            <input type="text" class="form-control slide-text-color-text" value="{{ $slide['text_color'] ?? '#000000' }}" placeholder="#000000" style="flex: 1;">
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="color-picker-wrapper">
                                            <input type="color" class="form-control color-input slide-btn-bg-color" name="slides[{{ $index }}][button_bg_color]" value="{{ $slide['button_bg_color'] ?? '#000000' }}" style="width: 80px; height: 45px; padding: 0; border: 1px solid #000000; border-radius: 8px; cursor: pointer;">
                                            <div class="color-preview slide-btn-bg-color-preview" style="background-color: {{ $slide['button_bg_color'] ?? '#000000' }};"></div>
                                            <input type="text" class="form-control slide-btn-bg-color-text" value="{{ $slide['button_bg_color'] ?? '#000000' }}" placeholder="#000000" style="flex: 1;">
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="color-picker-wrapper">
                                            <input type="color" class="form-control color-input slide-btn-text-color" name="slides[{{ $index }}][button_text_color]" value="{{ $slide['button_text_color'] ?? '#ffffff' }}" style="width: 80px; height: 45px; padding: 0; border: 1px solid #000000; border-radius: 8px; cursor: pointer;">
                                            <div class="color-preview slide-btn-text-color-preview" style="background-color: {{ $slide['button_text_color'] ?? '#ffffff' }};"></div>
                                            <input type="text" class="form-control slide-btn-text-color-text" value="{{ $slide['button_text_color'] ?? '#ffffff' }}" placeholder="#ffffff" style="flex: 1;">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="file-upload-area slide-image-upload" data-slide-index="{{ $index }}" style="cursor: pointer;">
                                            <input type="file" name="slide_images[{{ $index }}]" class="slide-image-input" accept="image/*" style="display: none;" data-slide-index="{{ $index }}">
                                        ...
                                        <input type="hidden" class="slide-image-path" name="slides[{{ $index }}][image]" value="{{ $slide['image'] ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="show_featured_products" {{ $settings->show_featured_products ? 'checked' : '' }}>
                    <span class="toggle-slider"></span>
                </label>
            </div>
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="show_new_arrivals" {{ $settings->show_new_arrivals ? 'checked' : '' }}>
                    <span class="toggle-slider"></span>
                </label>
            </div>
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="show_testimonials" {{ $settings->show_testimonials ? 'checked' : '' }}>
                    <span class="toggle-slider"></span>
                </label>
            </div>
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="show_about_section" {{ $settings->show_about_section ? 'checked' : '' }}>
                    <span class="toggle-slider"></span>
                </label>
            </div>
        </div>
