        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <div class="menu-items-container" id="menuItemsContainer">
                    ...
                    <div class="menu-item-card" data-index="{{ $index }}" data-order="{{ $item['order'] ?? ($index + 1) }}">
                        <div class="menu-item-handle">
                            <i class="fas fa-grip-vertical"></i>
                        </div>
                        <div class="menu-item-content">
                            <div class="menu-item-header">
                                <strong class="menu-item-label">{{ $item['label'] ?? 'Menu Item' }}</strong>
                                <span class="menu-item-url text-muted small">{{ $item['url'] ?? '#' }}</span>
                            </div>
                        ...
                        <input type="hidden" name="menu_items[{{ $index }}][label]" value="{{ $item['label'] ?? '' }}">
                        <input type="hidden" name="menu_items[{{ $index }}][url]" value="{{ $item['url'] ?? '' }}">
                        <input type="hidden" name="menu_items[{{ $index }}][type]" value="{{ $item['type'] ?? 'link' }}">
                        <input type="hidden" name="menu_items[{{ $index }}][order]" value="{{ $item['order'] ?? ($index + 1) }}">
                    </div>
                    @endforeach
...
let menuItems = @json($navigationLinks ?? []);
