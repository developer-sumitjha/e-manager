        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="show_banner" {{ $settings->show_banner ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="banner_title" value="{{ $settings->banner_title }}" placeholder="Welcome to Our Store">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="banner_subtitle" value="{{ $settings->banner_subtitle }}" placeholder="Find amazing products at great prices">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="banner_button_text" value="{{ $settings->banner_button_text }}" placeholder="Shop Now">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="banner_button_link" value="{{ $settings->banner_button_link }}" placeholder="/products">
                    </div>
                </div>
            </div>
        </div>
...
function saveBanner() {
    ...
    if (bannerFile) {
        ...
        fetch('{{ route('admin.site-builder.upload-banner-image') }}', {
            method: 'POST',
            headers: {
...
function saveBannerSettings(formData) {
    return fetch('{{ route('admin.site-builder.update-banner') }}', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': '{{ csrf_token() }}',
            'Accept': 'application/json'
