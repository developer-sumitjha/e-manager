    ...
    <form id="ecommerceForm">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-select" name="currency">
                            <option value="NPR" {{ $settings->currency == 'NPR' ? 'selected' : '' }}>NPR - Nepali Rupee</option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-select" name="currency_position">
                            <option value="before" {{ $settings->currency_position == 'before' ? 'selected' : '' }}>Before (Rs.100)</option>
                            <option value="after" {{ $settings->currency_position == 'after' ? 'selected' : '' }}>After (100 Rs.)</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="enable_guest_checkout" {{ $settings->enable_guest_checkout ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="enable_reviews" {{ $settings->enable_reviews ? 'checked' : '' }}>
                    <span class="toggle-slider"></span>
                </label>
            </div>
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="enable_wishlist" {{ $settings->enable_wishlist ? 'checked' : '' }}>
                    <span class="toggle-slider"></span>
                </label>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="min_order_amount" value="{{ $settings->min_order_amount }}" step="0.01" placeholder="0.00">
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="shipping_cost" value="{{ $settings->shipping_cost }}" step="0.01">
            </div>
            
            <div class="form-group">
                <label class="form-label">Free Shipping Over</label>
                <label class="toggle-switch">
                    <input type="checkbox" name="free_shipping_over" {{ $settings->free_shipping_over ? 'checked' : '' }}>
                    <span class="toggle-slider"></span>
                </label>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="free_shipping_amount" value="{{ $settings->free_shipping_amount }}" step="0.01" placeholder="1000.00">
            </div>
        </div>
...
function saveEcommerce() {
    ...
    fetch('{{ route('admin.site-builder.update-ecommerce') }}', {
        method: 'POST',
        headers: {
