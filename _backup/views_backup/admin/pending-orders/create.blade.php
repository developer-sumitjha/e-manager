...
@section('title', 'Create Pending Order')
@section('page-title', 'Create Pending Order')
...
<form action="{{ route('admin.pending-orders.store') }}" method="POST" id="createOrderForm">
    @csrf
        ...
        <div class="form-section">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="receiver_area" name="receiver_area" 
                               value="{{ old('receiver_area') }}" required 
            ...
            <div class="form-group">
                ...
                <textarea class="form-control form-textarea" id="shipping_address" name="shipping_address" 
                          rows="3" required placeholder="House/Flat number, Street, Landmark, City">{{ old('shipping_address') }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="delivery_branch" name="delivery_branch" 
                               value="{{ old('delivery_branch', 'HEAD OFFICE') }}" 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select" id="package_access" name="package_access">
                            <option value="Can't Open" {{ old('package_access') == "Can't Open" ? 'selected' : '' }}>Can't Open</option>
                            <option value="Can Open" {{ old('package_access') == "Can Open" ? 'selected' : '' }}>Can Open</option>
                        </select>
                        <small class="text-muted">Can the package be opened during delivery?</small>
                        @error('package_access')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-select" id="delivery_type" name="delivery_type">
                            <option value="Drop Off" {{ old('delivery_type') == "Drop Off" ? 'selected' : '' }}>Drop Off</option>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="delivery_instructions" name="delivery_instructions" 
                                  rows="2" placeholder="Special delivery instructions, landmarks, etc.">{{ old('delivery_instructions') }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sender_name" name="sender_name" 
                               value="{{ old('sender_name', 'E-Manager Store') }}" 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="sender_phone" name="sender_phone" 
                               value="{{ old('sender_phone', '+92XXXXXXXXXX') }}" 
                               placeholder="+92XXXXXXXXXX">
                        <small class="text-muted">For Gaaubesi order contact</small>
                        @error('sender_phone')
                            <div class="text-danger mt-1">{{ $message }}</div>
                    ...
                    <div class="product-row">
                        ...
                        <div class="quantity-input">
                            ...
                            <input type="number" class="form-control" name="quantities[]" 
                                   value="{{ old('quantities.'.$index, 1) }}" min="1" required onchange="calculateTotal()">
                        </div>
                        <div class="price-display">
                            <label class="form-label">Price</label>
                            <div id="price-{{ $index }}">₹0.00</div>
                        </div>
                        <div>
