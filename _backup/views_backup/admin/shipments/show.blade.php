...
<div class="shipment-header">
    ...
    <a href="{{ route('admin.shipments.index') }}" class="back-btn">
...
<div class="shipment-details">
    <div class="details-card">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">
                <span class="method-badge method-{{ $shipment->method }}">
                    {{ ucfirst($shipment->method) }}
                </span>
            </span>
        </div>
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">
                <a href="{{ route('admin.orders.show', $shipment->order_id) }}" class="text-decoration-none">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">{{ $shipment->order->user->name ?? 'N/A' }}</span>
        </div>
        
        <div class="detail-row">
            <span class="detail-label">Shipping Address</span>
            <span class="detail-value">{{ $shipment->order->shipping_address }}</span>
        </div>
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">{{ $shipment->createdBy->name ?? 'System' }}</span>
        </div>
        
        <div class="detail-row">
            <span class="detail-label">Created At</span>
            <span class="detail-value">{{ $shipment->created_at->format('M d, Y H:i') }}</span>
        </div>
        
        @if($shipment->shipped_at)
        <div class="detail-row">
            <span class="detail-label">Shipped At</span>
            <span class="detail-value">{{ $shipment->shipped_at->format('M d, Y H:i') }}</span>
        </div>
        @endif
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">{{ $shipment->delivered_at->format('M d, Y H:i') }}</span>
        </div>
        @endif
    </div>
    ...
    <div class="details-card">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">₹{{ number_format($shipment->order->total, 2) }}</span>
        </div>
        
        <div class="detail-row">
            <span class="detail-label">Payment Status</span>
            <span class="detail-value">
                <span class="status-badge status-{{ $shipment->order->payment_status }}">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">{{ ucfirst(str_replace('_', ' ', $shipment->order->payment_method)) }}</span>
        </div>
        
        <div class="detail-row">
            <span class="detail-label">Order Status</span>
            <span class="detail-value">
                <span class="status-badge status-{{ $shipment->order->status }}">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">{{ $shipment->order->orderItems->count() }} items</span>
        </div>
        
        <div class="detail-row">
            <span class="detail-label">Order Date</span>
            <span class="detail-value">{{ $shipment->order->created_at->format('M d, Y') }}</span>
        </div>
    </div>
</div>
...
<div class="timeline">
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-content">
            ...
            <div class="timeline-date">{{ $shipment->created_at->format('M d, Y H:i') }}</div>
        </div>
    </div>
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-content">
            ...
            <div class="timeline-date">{{ $shipment->shipped_at->format('M d, Y H:i') }}</div>
        </div>
    </div>
    @endif
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-content">
            ...
            <div class="timeline-date">{{ $shipment->delivered_at->format('M d, Y H:i') }}</div>
        </div>
    </div>
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-content">
            ...
            <div class="timeline-date">{{ $shipment->updated_at->format('M d, Y H:i') }}</div>
        </div>
    </div>
    @endif
</div>
...
<div class="actions-section">
    <a href="{{ route('admin.shipments.edit', $shipment->id) }}" class="action-btn edit">
...
<script>
    ...
    function confirmUpdateStatus() {
        ...
        fetch('{{ route("admin.shipments.update-status", $shipment->id) }}', {
            method: 'POST',
            headers: {
    ...
    function deleteShipment() {
        if (confirm('Are you sure you want to delete this shipment? This action cannot be undone.')) {
            fetch('{{ route("admin.shipments.destroy", $shipment->id) }}', {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}',
                    'Content-Type': 'application/json'
