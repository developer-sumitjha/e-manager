...
@section('settings-title', 'Email Configuration')
@section('settings-description', 'Setup SMTP server, email templates, and notification preferences')
@section('settings-icon', 'envelope')
@section('settings-group', 'email')
