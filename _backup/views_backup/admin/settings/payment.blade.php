...
@section('settings-title', 'Payment Settings')
@section('settings-description', 'Configure payment gateways, COD settings, and transaction options')
@section('settings-icon', 'credit-card')
