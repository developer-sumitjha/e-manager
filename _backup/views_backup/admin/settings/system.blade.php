...
@section('settings-title', 'System Settings')
@section('settings-description', 'Configure maintenance mode, backups, logs, and system options')
@section('settings-icon', 'server')
