...
@section('title', 'COD Settlement')
@section('page-title', 'COD Settlement')
                ...
                <div class="settlement-stats">
                    <div class="stat-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-content">
                                <h3>Rs. {{ number_format($settlementStats['total_cod_amount'], 0) }}</h3>
                    ...
                    <div class="stat-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-content">
                                <h3>Rs. {{ number_format($settlementStats['pending_cod_amount'], 0) }}</h3>
                    ...
                    <div class="stat-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-content">
                                <h3>Rs. {{ number_format($settlementStats['settled_cod_amount'], 0) }}</h3>
                                <p>Settled Amount</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="stat-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-content">
                                <h3>{{ $settlementStats['pending_count'] }}</h3>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <strong>{{ $shipment->order->user->name ?? 'N/A' }}</strong>
                                            <br>
                                            <small class="text-muted">{{ $shipment->order->user->phone ?? 'N/A' }}</small>
                                        </div>
                                    </td>
                                    <td class="cod-amount">Rs. {{ number_format($shipment->cod_charge, 0) }}</td>
                                    <td>{{ $shipment->delivered_at ? $shipment->delivered_at->format('M d, Y') : 'Not delivered' }}</td>
                                    <td>
                                        <span class="settlement-status {{ $shipment->cod_paid ? 'settled' : 'pending' }}">
                                            {{ $shipment->cod_paid ? 'Settled' : 'Pending' }}
                                        </span>
                                    </td>
                                    <td>
                                        @if(!$shipment->cod_paid && $shipment->delivered_at)
                                            <button class="action-btn settle" onclick="openSettleModal({{ $shipment->id }}, {{ $shipment->cod_charge }})">
                                                <i class="fas fa-money-bill-wave"></i> Settle
                                            </button>
                                        @endif
                                        <a href="{{ route('admin.gaaubesi.show', $shipment) }}" class="action-btn view">
