...
<div class="financial-metrics-grid">
    ...
    <div class="metric-card">
        ...
        <div class="metric-value">₹{{ number_format($metrics['total_expenses'], 2) }}</div>
        <div class="metric-subtitle">This month</div>
    ...
    <div class="metric-card">
        ...
        <div class="metric-value">₹{{ number_format($metrics['net_income'], 2) }}</div>
    ...
    <div class="metric-card">
        ...
        <div class="metric-value">₹{{ number_format($metrics['cash_balance'], 2) }}</div>
