...
function toggleProductStatus(toggle) {
    ...
    AjaxHelper.put(`/admin/products/${productId}/status`, {
        is_active: isActive
    })
    .then(response => {
...
function duplicateProduct(productId) {
    ...
    AjaxHelper.post(`/admin/products/${productId}/duplicate`)
    .then(response => {
...
function deleteProduct(productId) {
    ...
    AjaxHelper.delete(`/admin/products/${productId}`)
    .then(response => {
...
function performBulkAction(action) {
    ...
    AjaxHelper.post('/admin/products/bulk-action', {
        action: action,
