...
<body>
    <div class="sidebar">
        <div class="sidebar-header">
            ...
            <h3>Super Admin</h3>
            <p style="margin: 0; opacity: 0.9; font-size: 0.9rem;">{{ Auth::guard('super_admin')->user()->name }}</p>
        </div>
        <ul class="sidebar-menu">
            <li><a href="{{ route('super.dashboard') }}" class="{{ request()->routeIs('super.dashboard') ? 'active' : '' }}"><i class="fas fa-home"></i><span>Dashboard</span></a></li>
            <li><a href="{{ route('super.tenants.index') }}" class="{{ request()->routeIs('super.tenants.*') ? 'active' : '' }}"><i class="fas fa-building"></i><span>Tenants</span></a></li>
            <li><a href="{{ route('super.subscriptions.index') }}" class="{{ request()->routeIs('super.subscriptions.*') ? 'active' : '' }}"><i class="fas fa-credit-card"></i><span>Subscriptions</span></a></li>
            <li><a href="{{ route('super.plans.index') }}" class="{{ request()->routeIs('super.plans.*') ? 'active' : '' }}"><i class="fas fa-tags"></i><span>Plans</span></a></li>
            <li><a href="{{ route('super.payments.index') }}" class="{{ request()->routeIs('super.payments.*') ? 'active' : '' }}"><i class="fas fa-money-bill-wave"></i><span>Payments</span></a></li>
            <li><a href="{{ route('super.analytics') }}" class="{{ request()->routeIs('super.analytics') ? 'active' : '' }}"><i class="fas fa-chart-line"></i><span>Analytics</span></a></li>
            <li><a href="{{ route('super.site-builder.public.index') }}" class="{{ request()->routeIs('super.site-builder.public.*') ? 'active' : '' }}"><i class="fas fa-paint-brush"></i><span>Site Builder</span></a></li>
            <li style="margin-top: 2rem; padding: 0 1.5rem;"><form action="{{ route('super.logout') }}" method="POST">@csrf<button type="submit" class="btn btn-danger w-100"><i class="fas fa-sign-out-alt"></i> Logout</button></form></li>
        </ul>
    </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="btn-group" role="group">
                        <a href="{{ route('vendor.login') }}" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-store"></i> Admin Login
                        </a>
                        <a href="{{ route('vendor.register') }}" class="btn btn-primary btn-sm">
