...
@section('title', 'My Profile — ' . $tenant->business_name)
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('customer.profile', $tenant->subdomain) }}" class="list-group-item list-group-item-action active">
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customer.profile', $tenant->subdomain) }}">
                        @csrf
