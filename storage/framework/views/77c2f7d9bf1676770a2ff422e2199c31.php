...
<?php $__env->startSection('page-subtitle', 'Manage user roles, permissions, and account status'); ?>
        ...
        <div class="col-lg-8">
            <div class="hero-content">
                ...
                <div class="hero-stats">
                    <div class="hero-stat">
                        <span class="hero-stat-value" data-count="<?php echo e($users->total()); ?>">0</span>
                        <span class="hero-stat-label">Total Users</span>
                    </div>
                    <div class="hero-stat">
                        <span class="hero-stat-value" data-count="<?php echo e($users->where('is_active', true)->count()); ?>">0</span>
                        <span class="hero-stat-label">Active Users</span>
                    </div>
                    <div class="hero-stat">
                        <span class="hero-stat-value" data-count="<?php echo e($users->where('is_active', false)->count()); ?>">0</span>
        ...
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <select name="role" class="form-select">
                    ...
                    <?php $__currentLoopData = ['admin'=>'Admin','employee'=>'Employee','delivery_boy'=>'Delivery Boy','customer'=>'Customer']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr data-user-id="<?php echo e($user->id); ?>">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm me-3">
                                    <div class="avatar-initials">
                                        <?php echo e(strtoupper(substr($user->name ?? $user->email, 0, 1))); ?>
                        ...
                        <td>
                            <div class="text-truncate" style="max-width: 200px;"><?php echo e($user->email); ?></div>
                        </td>
                        <td>
                            <span class="badge badge-<?php echo e($user->role == 'admin' ? 'danger' : ($user->role == 'employee' ? 'warning' : ($user->role == 'delivery_boy' ? 'info' : 'secondary'))); ?>">
                        ...
                        <td>
                            <span class="badge badge-secondary"><?php echo e($user->orders_count ?? 0); ?></span>
                        </td>
                        <td>
                            <div class="text-muted"><?php echo e($user->created_at->format('M j, Y')); ?></div>
                            <small class="text-muted"><?php echo e($user->created_at->format('g:i A')); ?></small>
                        </td>
                        <td>
...
function exportUsers() {
    const url = new URL('<?php echo e(route("admin.users.export")); ?>');
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/users/index.blade.php ENDPATH**/ ?>