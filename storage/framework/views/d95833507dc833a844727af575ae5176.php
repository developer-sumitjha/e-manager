...
<div class="row">
    ...
    <div class="col-xl-4">
            ...
            <div class="card-body">
                ...
                <div class="row g-2">
                    <div class="col-12">
                        ...
                        <div class="fw-semibold"><?php echo e($order->receiver_phone ?? $order->user->phone ?? 'N/A'); ?></div>
                    </div>
                    <?php if($order->user): ?>
                    <div class="col-12">
                        <small class="text-muted">Email</small>
                        <div class="fw-semibold"><?php echo e($order->user->email ?? 'N/A'); ?></div>
                    </div>
                    <div class="col-12">
        ...
        <!-- Shipping Address -->
        <?php if($order->shipping_address || $order->receiver_name || $order->receiver_full_address): ?>
        <div class="card mb-4">
            <div class="card-header">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <?php if($order->receiver_full_address): ?>
                <div class="text-muted mb-2"><?php echo e($order->receiver_full_address); ?></div>
                <?php elseif($order->shipping_address): ?>
                <div class="text-muted mb-2"><?php echo e($order->shipping_address); ?></div>
                <?php endif; ?>
