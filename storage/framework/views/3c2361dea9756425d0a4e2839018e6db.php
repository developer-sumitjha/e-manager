...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="products-section">
            ...
            <div id="productsContainer">
                <?php if($pending_order->orderItems->count() > 0): ?>
                    <?php $__currentLoopData = $pending_order->orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="product-row">
                            ...
                            <div class="quantity-input">
                                ...
                                <input type="number" class="form-control" name="quantities[]" 
                                       value="<?php echo e($item->quantity); ?>" min="1" required onchange="calculateTotal()">
                            </div>
                            <div class="price-display">
                                <label class="form-label">Price</label>
                                <div id="price-<?php echo e($index); ?>">₹<?php echo e(number_format($item->price * $item->quantity, 2)); ?></div>
                            </div>
                            <div>
    ...
    <div class="order-summary">
        ...
        <div class="summary-row">
            ...
            <span class="summary-value" id="subtotal">₹<?php echo e(number_format($pending_order->subtotal ?? 0, 2)); ?></span>
        </div>
        <div class="summary-row">
            <span class="summary-label">Total:</span>
            <span class="summary-value" id="total">₹<?php echo e(number_format($pending_order->total ?? 0, 2)); ?></span>
        </div>
    </div>
...
<script>
    let productCounter = <?php echo e($pending_order->orderItems->count()); ?>;
