    ...
    <form id="generalForm">
        ...
        <div class="form-section">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="site_tagline" value="<?php echo e($settings->site_tagline); ?>" placeholder="Your catchy tagline">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="site_description" rows="3" placeholder="Describe your store..."><?php echo e($settings->site_description); ?></textarea>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="image-preview-box mt-3">
                            ...
                            ?>
                            <img src="<?php echo e($logoUrl); ?>" alt="Current Logo" style="max-width: 100%; height: auto; border: 1px solid #ddd; border-radius: 8px; padding: 8px;">
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="image-preview-box mt-3">
                            ...
                            ?>
                            <img src="<?php echo e($faviconUrl); ?>" alt="Current Favicon" style="max-width: 100%; height: auto; border: 1px solid #ddd; border-radius: 8px; padding: 8px;">
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="form-section">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="contact_email" value="<?php echo e($settings->contact_email); ?>" placeholder="hello@yourdomain.com">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="contact_phone" value="<?php echo e($settings->contact_phone); ?>" placeholder="+977 9841234567">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="address" rows="2" placeholder="Your business address"><?php echo e($settings->address); ?></textarea>
            </div>
        </div>
...
function saveGeneral() {
    ...
    // Save basic info
    fetch('<?php echo e(route('admin.site-builder.update-basic-info')); ?>', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        if (data.success) {
            ...
            if (logoFile) {
                ...
                return fetch('<?php echo e(route('admin.site-builder.upload-logo')); ?>', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                        'Accept': 'application/json'
    ...
    .then(data => {
        ...
        if (faviconFile) {
            ...
            return fetch('<?php echo e(route('admin.site-builder.upload-favicon')); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                    'Accept': 'application/json'
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/site-builder/tabs/general.blade.php ENDPATH**/ ?>