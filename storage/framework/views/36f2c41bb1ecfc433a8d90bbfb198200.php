...
<div class="sales-summary">
    <div class="summary-card">
        ...
        <div class="summary-value">₹<?php echo e(number_format($sales->sum('total'), 2)); ?></div>
        <div class="summary-subtitle">From <?php echo e($sales->count()); ?> orders</div>
    </div>
    ...
    <div class="summary-card">
        ...
        <div class="summary-value"><?php echo e($sales->count()); ?></div>
    ...
    <div class="summary-card">
        ...
        <div class="summary-value">₹<?php echo e($sales->count() > 0 ? number_format($sales->avg('total'), 2) : '0.00'); ?></div>
    ...
    <div class="summary-card">
        ...
        <div class="summary-value">₹<?php echo e(number_format($sales->where('created_at', '>=', today())->sum('total'), 2)); ?></div>
...
<div class="filters-bar">
    <div class="search-box">
        ...
        <input type="text" id="sales-search" class="form-control" placeholder="Search orders..." value="<?php echo e(request('search')); ?>">
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="order-id"><?php echo e($sale->order_number); ?></div>
                    </td>
                    <td>
                        <div class="customer-info">
                            <div class="customer-name"><?php echo e($sale->user->name ?? 'N/A'); ?></div>
                            <div class="customer-email"><?php echo e($sale->user->email ?? 'N/A'); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="amount-value">₹<?php echo e(number_format($sale->total, 2)); ?></div>
                    </td>
                    <td>
                    ...
                    <td>
                        <span class="payment-badge payment-<?php echo e($sale->payment_status); ?>">
                            <?php echo e(ucfirst($sale->payment_status)); ?>

                        </span>
                    </td>
                    <td>
                        <div class="order-date"><?php echo e($sale->created_at->format('M d, Y')); ?></div>
                    </td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('admin.orders.show', $sale->id)); ?>" class="action-btn view">
                                <i class="fas fa-eye"></i> View
                            </a>
                            <?php if(!$sale->invoice): ?>
                            <a href="<?php echo e(route('admin.accounting.create-invoice', $sale->id)); ?>" class="action-btn invoice">
                                <i class="fas fa-file-invoice"></i> Invoice
                            </a>
                            <?php else: ?>
                            <a href="<?php echo e(route('admin.accounting.invoices.show', $sale->invoice->id)); ?>" class="action-btn invoice">
...
<script>
    ...
    function applyFilters() {
        ...
        window.location.href = `<?php echo e(route('admin.accounting.sales')); ?>?${params.toString()}`;
    }
</script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/accounting/sales.blade.php ENDPATH**/ ?>