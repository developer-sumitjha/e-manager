    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-body">
                ...
                <form method="POST" action="<?php echo e(route('super.login')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/super-admin/login.blade.php ENDPATH**/ ?>