...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-check mb-3">
                        <input type="checkbox" name="is_active" class="form-check-input" id="isActive" <?php echo e(old('is_active', true) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-check mb-3">
                        <input type="checkbox" name="show_in_menu" class="form-check-input" id="showInMenu" <?php echo e(old('show_in_menu', true) ? 'checked' : ''); ?>>
