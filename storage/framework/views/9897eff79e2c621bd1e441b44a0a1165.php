...
<div class="container">
    ...
    <!-- New Arrivals Section -->
    <?php if(($settings->show_new_arrivals ?? false) && isset($newArrivals) && $newArrivals->count() > 0): ?>
    <section id="new-arrivals" class="new-arrivals-section">
        <div class="section-header">
            <h2 class="section-title">New Arrivals</h2>
            <a href="<?php echo e(\App\Helpers\StorefrontHelper::route('storefront.dynamic', [$tenant->subdomain, ($settings->additional_settings['products_archive_slug'] ?? 'products')])); ?>?sort=new" class="view-all-link">View All <i class="fas fa-arrow-right"></i></a>
        </div>
    ...
    <!-- Banner Section -->
    <?php if(($settings->show_banner ?? true) && (trim($settings->banner_title ?? '') !== '' || trim($settings->banner_subtitle ?? '') !== '' || trim($settings->banner_button_text ?? '') !== '' || !empty($settings->banner_image))): ?>
    <section id="banner" class="banner-section">
        ...
        <div class="banner-image-wrapper">
            ...
            ?>
            <img src="<?php echo e($bannerUrl); ?>" alt="<?php echo e($settings->banner_title ?? 'Banner'); ?>">
        </div>
        <?php endif; ?>
        <div class="content">
            <?php if(trim($settings->banner_title ?? '') !== ''): ?>
                <h2><?php echo e($settings->banner_title); ?></h2>
            <?php endif; ?>
            <?php if(trim($settings->banner_subtitle ?? '') !== ''): ?>
                <p><?php echo e($settings->banner_subtitle); ?></p>
            <?php endif; ?>
            <?php if(trim($settings->banner_button_text ?? '') !== ''): ?>
                <a href="<?php echo e(trim($settings->banner_button_link ?? '') !== '' ? $settings->banner_button_link : '#products'); ?>" class="btn btn-primary btn-lg"><?php echo e($settings->banner_button_text); ?></a>
            <?php endif; ?>
        </div>
    </section>
    <?php endif; ?>
