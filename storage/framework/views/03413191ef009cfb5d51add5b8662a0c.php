...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Panel'); ?> - <?php echo e(config('app.name', 'E-Manager')); ?></title>
    ...
    <!-- DealDeck Theme CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/theme-dealdeck.css')); ?>?v=<?php echo e(time()); ?>">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-logo">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="E-Manager Logo" onerror="this.style.display='none'">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.inventory.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.inventory.*') ? 'active' : ''); ?>">
                            <i class="nav-icon fas fa-warehouse"></i>
                            <span class="nav-text">Inventory</span>
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.stock-adjustments.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.stock-adjustments.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.shipments.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.shipments.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.gaaubesi.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.gaaubesi.*') ? 'active' : ''); ?>">
                            <i class="nav-icon fas fa-shipping-fast"></i>
                            <span class="nav-text">Gaaubesi Logistics</span>
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.pathao.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.pathao.*') ? 'active' : ''); ?>">
                            <i class="nav-icon fas fa-truck"></i>
                    ...
                    <div class="nav-item has-submenu">
                        ...
                        <div class="submenu">
                            <a href="<?php echo e(route('admin.manual-delivery.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.manual-delivery.index') ? 'active' : ''); ?>">
                                <i class="nav-icon fas fa-chart-line"></i>
                                <span class="nav-text">Dashboard</span>
                            </a>
                            <a href="<?php echo e(route('admin.manual-delivery.allocation')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.manual-delivery.allocation') ? 'active' : ''); ?>">
                                <i class="nav-icon fas fa-truck"></i>
                                <span class="nav-text">Order Allocation</span>
                            </a>
                            <a href="<?php echo e(route('admin.manual-delivery.delivery-boys')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.manual-delivery.delivery-boys') ? 'active' : ''); ?>">
                                <i class="nav-icon fas fa-users"></i>
                                <span class="nav-text">Delivery Boys</span>
                            </a>
                            <a href="<?php echo e(route('admin.manual-delivery.cod-settlements')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.manual-delivery.cod-settlements') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item has-submenu">
                        ...
                        <div class="submenu">
                            <a href="<?php echo e(route('admin.accounting.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.accounting.index') ? 'active' : ''); ?>">
                                <i class="nav-icon fas fa-chart-pie"></i>
                                <span class="nav-text">Overview</span>
                            </a>
                            <a href="<?php echo e(route('admin.accounting.sales')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.accounting.sales') ? 'active' : ''); ?>">
                                <i class="nav-icon fas fa-chart-line"></i>
                                <span class="nav-text">Sales</span>
                            </a>
                            <a href="<?php echo e(route('admin.accounting.expenses')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.accounting.expenses') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.site-builder.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.site-builder.*') ? 'active' : ''); ?>">
                            <i class="nav-icon fas fa-paint-brush"></i>
                            <span class="nav-text">Site Builder</span>
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.site-pages.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.site-pages.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.subscription.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.subscription.*') ? 'active' : ''); ?>">
                ...
                <div class="header-left">
                    ...
                    <nav class="breadcrumb" aria-label="Breadcrumb">
                        <div class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="breadcrumb-link" aria-label="Dashboard home">
                ...
                <div class="header-right">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-outline-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" aria-label="User menu">
                            ...
                            <span><?php echo e(auth()->user()->first_name ?? 'Admin'); ?></span>
                        </button>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>