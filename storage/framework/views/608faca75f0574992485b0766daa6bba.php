        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <select class="form-select" name="product_card_style">
                    <option value="card" <?php echo e($settings->product_card_style == 'card' ? 'selected' : ''); ?>>Card</option>
                    <option value="grid" <?php echo e($settings->product_card_style == 'grid' ? 'selected' : ''); ?>>Grid</option>
                    <option value="list" <?php echo e($settings->product_card_style == 'list' ? 'selected' : ''); ?>>List</option>
                </select>
            </div>
            
            <div class="form-group">
                <label class="form-label">Products Per Page</label>
                <input type="number" class="form-control" name="products_per_page" value="<?php echo e($settings->products_per_page); ?>" min="6" max="48">
            </div>
            
            <div class="form-group">
                <label class="form-label">Show Product Ratings</label>
                <label class="toggle-switch">
                    <input type="checkbox" name="show_product_ratings" <?php echo e($settings->show_product_ratings ? 'checked' : ''); ?>>
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="show_quick_view" <?php echo e($settings->show_quick_view ? 'checked' : ''); ?>>
                    <span class="toggle-slider"></span>
                </label>
            </div>
            ...
            <div class="form-group">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" name="show_add_to_cart_button" <?php echo e($settings->show_add_to_cart_button ? 'checked' : ''); ?>>
                    <span class="toggle-slider"></span>
                </label>
            </div>
        </div>
...
function saveProducts() {
    ...
    fetch('<?php echo e(route('admin.site-builder.update-products')); ?>', {
        method: 'POST',
        headers: {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/site-builder/tabs/products.blade.php ENDPATH**/ ?>