...
<body>
    ...
    <div class="main-content">
        ...
        <div class="action-bar">
            <div class="search-box">
                ...
                <input type="text" id="searchInput" placeholder="Search vendors..." value="<?php echo e(request('search')); ?>">
            </div>
            ...
            <a href="<?php echo e(route('super.tenants.export')); ?>?<?php echo e(http_build_query(request()->all())); ?>" class="btn-success">
                <i class="fas fa-download"></i> Export CSV
            </a>

            <a href="<?php echo e(route('super.tenants.create')); ?>" class="btn-primary-gradient">
            ...
            <div class="table-responsive">
                <table class="modern-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" class="checkbox-custom tenant-checkbox" value="<?php echo e($tenant->id); ?>">
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="tenant-avatar"><?php echo e(strtoupper(substr($tenant->business_name, 0, 2))); ?></div>
                                    <div>
                                        <strong style="display: block;"><?php echo e($tenant->business_name); ?></strong>
                                        <small style="color: #64748b;"><?php echo e($tenant->tenant_id); ?></small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div>
                                    <strong style="display: block;"><?php echo e($tenant->business_email); ?></strong>
                                    <small style="color: #64748b;"><?php echo e($tenant->business_phone); ?></small>
                                </div>
                            </td>
                            <td>
                                <strong><?php echo e($tenant->currentPlan->name ?? 'No Plan'); ?></strong>
                            </td>
                            <td>
                                <span class="badge-status <?php echo e($tenant->status); ?>"><?php echo e(ucfirst($tenant->status)); ?></span>
                            </td>
                            <td><?php echo e($tenant->created_at->format('M d, Y')); ?></td>
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="<?php echo e(route('super.tenants.show', $tenant)); ?>" class="action-btn" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('super.tenants.edit', $tenant)); ?>" class="action-btn" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="<?php echo e(route('super.tenants.analytics', $tenant)); ?>" class="action-btn" title="Analytics">
                                        <i class="fas fa-chart-line"></i>
                                    </a>
                                    <button onclick="checkHealth(<?php echo e($tenant->id); ?>)" class="action-btn" title="Health">
    ...
    <script>
        ...
        function applyFilters() {
            ...
            let url = '<?php echo e(route("super.tenants.index")); ?>?';
        ...
        function executeBulkAction() {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route("super.tenants.bulk-action")); ?>';
            form.innerHTML = `
                <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/super-admin/tenants/index.blade.php ENDPATH**/ ?>