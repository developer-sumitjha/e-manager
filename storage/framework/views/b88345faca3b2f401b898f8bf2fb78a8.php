...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo e(route('super.plans.index')); ?>" class="active"><i class="fas fa-layer-group"></i> Plans</a></li>
    ...
    <div class="main-content">
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('super.plans.create')); ?>" class="btn-primary-gradient">
        ...
        <div class="plans-grid">
            ...
            <div class="plan-card">
                ...
                <div class="plan-header">
                    ...
                    <span class="badge-status <?php echo e($plan->is_active ? 'active' : 'inactive'); ?>">
                        <?php echo e($plan->is_active ? 'Active' : 'Inactive'); ?>

                    </span>
                    <div class="plan-price">
                        Rs. <?php echo e(number_format($plan->price_monthly, 0)); ?>

                        <small>/month</small>
                    </div>
                    <p style="color: #64748b; margin: 0;"><?php echo e($plan->description); ?></p>
                </div>

                <div class="plan-stats">
                    <div class="stat-item">
                        <div class="stat-value"><?php echo e($plan->tenants_count ?? 0); ?></div>
                        <div class="stat-label">Active Users</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-value"><?php echo e($plan->trial_days); ?></div>
                        <div class="stat-label">Trial Days</div>
                    </div>
                </div>

                <ul class="plan-features">
                    <li><i class="fas fa-check-circle"></i> <?php echo e(number_format($plan->max_products)); ?> Products</li>
                    <li><i class="fas fa-check-circle"></i> <?php echo e(number_format($plan->max_orders_per_month)); ?> Orders/Month</li>
                    <li><i class="fas fa-check-circle"></i> <?php echo e(number_format($plan->max_users)); ?> Users</li>
                ...
                <div class="plan-actions">
                    <a href="<?php echo e(route('super.plans.edit', $plan)); ?>" class="btn-primary-gradient">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <form action="<?php echo e(route('super.plans.destroy', $plan)); ?>" method="POST" style="flex: 1;" onsubmit="return confirm('Delete this plan?')">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/super-admin/plans/index.blade.php ENDPATH**/ ?>