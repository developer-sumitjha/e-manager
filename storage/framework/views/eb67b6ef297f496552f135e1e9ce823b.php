...
<div class="search-add-bar">
    <div class="search-box">
        ...
        <input type="text" id="inventory-search" class="form-control" placeholder="Search products..." value="<?php echo e(request('search')); ?>">
    </div>
...
<div class="filter-tabs">
    <a href="<?php echo e(route('admin.inventory.index', ['filter' => '', 'search' => request('search')])); ?>" class="filter-tab <?php echo e(request('filter') == '' ? 'active' : ''); ?>">
        <span>All</span>
        <span class="count-badge"><?php echo e($allCount); ?></span>
    </a>
    <a href="<?php echo e(route('admin.inventory.index', ['filter' => 'low_stock', 'search' => request('search')])); ?>" class="filter-tab <?php echo e(request('filter') == 'low_stock' ? 'active' : ''); ?>">
        <span>Low Stock</span>
        <span class="count-badge"><?php echo e($lowStockCount); ?></span>
    </a>
    <a href="<?php echo e(route('admin.inventory.index', ['filter' => 'out_of_stock', 'search' => request('search')])); ?>" class="filter-tab <?php echo e(request('filter') == 'out_of_stock' ? 'active' : ''); ?>">
        <span>Out of Stock</span>
        <span class="count-badge"><?php echo e($outOfStockCount); ?></span>
    </a>
</div>
                ...
                <tr data-product-id="<?php echo e($product->id); ?>">
                    ...
                    <td>
                        <div class="product-info">
                            <img src="<?php echo e($product->image ? asset('storage/' . $product->image) : asset('images/placeholder-product.jpg')); ?>" 
                    ...
                    <td>
                        <div class="stock-quantity"><?php echo e($product->stock); ?></div>
                        <div class="stock-status-badge <?php echo e($product->stock == 0 ? 'stock-status-out-of-stock' : ($product->stock <= 20 ? 'stock-status-low-stock' : 'stock-status-in-stock')); ?>">
                            <?php echo e($product->stock == 0 ? 'Out of Stock' : ($product->stock <= 20 ? 'Low Stock' : 'In Stock')); ?>

                        </div>
                    </td>
                    <td>
                        <div class="price-value">₹<?php echo e(number_format($product->sale_price ?? $product->price, 2)); ?></div>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="d-flex flex-wrap">
                            <a href="<?php echo e(route('admin.products.show', $product->id)); ?>" class="action-btn view">
                                <i class="fas fa-eye"></i> View
                            </a>
                            <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="action-btn edit">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <button type="button" class="action-btn delete" onclick="deleteProduct(<?php echo e($product->id); ?>)">
                                <i class="fas fa-trash"></i> Delete
                            </button>
                        </div>
                    </td>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        inventorySearch.addEventListener('keyup', debounce(function() {
            ...
            window.location.href = `<?php echo e(route('admin.inventory.index')); ?>?search=${searchValue}&filter=${currentFilter}`;
        }, 300));
    ...
    function confirmUpdateStock() {
        ...
        fetch('<?php echo e(route('admin.inventory.bulk-update-stock')); ?>', {
            method: 'POST',
            headers: {
    ...
    function bulkDelete() {
        ...
        if (confirm(`Are you sure you want to delete ${selectedProducts.length} products? This action cannot be undone.`)) {
            fetch('<?php echo e(route('admin.inventory.bulk-delete')); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/inventory/index.blade.php ENDPATH**/ ?>