...
<body>
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo e(route('super.financial.index')); ?>" class="active"><i class="fas fa-chart-pie"></i> Financial</a></li>
    ...
    <div class="main-content">
        ...
        <div class="stats-row">
            ...
            <div class="stat-card">
                <div class="stat-value">Rs. <?php echo e(number_format($stats['revenue_this_month'] ?? 0, 2)); ?></div>
            ...
            <div class="stat-card">
                <div class="stat-value">Rs. <?php echo e(number_format($stats['arr'] ?? 0, 2)); ?></div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($payment->tenant->business_name ?? 'N/A'); ?></td>
                        <td>Rs. <?php echo e(number_format($payment->amount, 2)); ?></td>
                        <td><?php echo e(ucfirst($payment->payment_method ?? 'N/A')); ?></td>
                        <td><span class="badge bg-success"><?php echo e(ucfirst($payment->status)); ?></span></td>
                    </tr>
    ...
    <script>
        new Chart(document.getElementById('revenueChart'), {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Revenue',
                    data: <?php echo json_encode($revenueData ?? [0,0,0,0,0,0]); ?>,
                    borderColor: '#667eea',
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/super-admin/financial/index.blade.php ENDPATH**/ ?>