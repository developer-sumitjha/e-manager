...
<html lang="en">
    <head>
        ...
        <meta property="og:title" content="<?php echo e(data_get($data,'branding.site_name','E‑Manager Nepal — SaaS Business Suite')); ?>">
    ...
    <body>
        <header class="header">
            <div class="container">
                <div class="row">
                    ...
                    <a class="brand" href="/"><i class="fas fa-mountain"></i> <?php echo e($data['branding']['site_name'] ?? 'E‑Manager Nepal'); ?></a>
                    ...
                    <div class="actions">
                        <a class="btn btn-outline" href="<?php echo e(route('vendor.login')); ?>"><i class="fas fa-right-to-bracket"></i> Admin Login</a>
                        <a class="btn btn-primary" href="<?php echo e(route('vendor.register')); ?>"><i class="fas fa-user-plus"></i> Create Admin</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <main>
            ...
            <section class="hero" id="home">
                ...
                <div class="container grid2">
                    <div>
                        ...
                        <h1 class="title reveal delay-1"><?php echo e(data_get($data,'hero.title','Run your business on one modern dashboard')); ?></h1>
                        <p class="lead reveal delay-2"><?php echo e(data_get($data,'hero.subtitle','Inventory, orders, deliveries, accounting and analytics — all stitched together with delightful UX and real‑time insights. Built in Nepal, for Nepal.')); ?></p>
                        <form class="hero-cta" action="<?php echo e(route('public.signup')); ?>" method="get" aria-label="Start free trial">
                            <input class="input" name="email" placeholder="Work email" aria-label="Work email" inputmode="email">
                            <a class="btn btn-primary" href="<?php echo e(data_get($data,'hero.cta_link', route('public.signup'))); ?>" aria-label="Start free trial"><i class="fas fa-rocket" aria-hidden="true"></i> <?php echo e(data_get($data,'hero.cta_text','Start free trial')); ?></a>
                        </form>
                    </div>
                    <div class="mock" aria-label="dashboard preview">
                        <img src="<?php echo e(asset('storage/hero-admin-dashboard.jpg')); ?>" alt="Admin dashboard preview" loading="lazy" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:.96">
                    </div>
                </div>
            </section>
            ...
            <section class="section" style="padding-top:0">
                <div class="container" style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
                    <div class="pill-card pill-purple">
                        ...
                        <form class="email-pill" action="<?php echo e(route('public.signup')); ?>" method="get">
                ...
                <div class="container">
                    ...
                    <div class="pricing">
                        ...
                        <div class="card reveal" style="display:flex;flex-direction:column;gap:.5rem">
                            <div class="muted" style="text-transform:uppercase;font-weight:800"><?php echo e($plan->name); ?></div>
                            <div class="price">NPR <?php echo e(number_format($plan->price_monthly,0)); ?> <span class="muted" style="font-size:1rem">/ mo</span></div>
                            <div class="muted">or NPR <?php echo e(number_format($plan->price_yearly,0)); ?> / yr</div>
                            <ul class="muted" style="line-height:1.9;margin:.5rem 0">
                                <li>Orders: <?php echo e($plan->max_orders_per_month >= 99999 ? 'Unlimited' : number_format($plan->max_orders_per_month)); ?>/mo</li>
                                <li>Users: <?php echo e($plan->max_users >= 99999 ? 'Unlimited' : number_format($plan->max_users)); ?></li>
                                <li>Storage: <?php echo e(number_format($plan->max_storage_gb)); ?> GB</li>
                                <li>60‑day free trial</li>
                            </ul>
                            <a class="btn btn-primary" href="<?php echo e(route('public.signup')); ?>?plan_id=<?php echo e($plan->id); ?>">Start free trial</a>
                        </div>
            ...
            <section class="section" id="contact" style="background:var(--paper)">
                <div class="container grid2">
                    ...
                    <form class="card reveal" action="<?php echo e(route('public.signup')); ?>" method="get">
        ...
        <footer class="footer">
            <div class="container">
                <div class="cta">
                    <a class="btn btn-outline btn-flag" href="<?php echo e(route('super.login')); ?>"><i class="fas fa-crown"></i> Super Admin Login</a>
                </div>
                <div style="text-align:center">&copy; <?php echo e(date('Y')); ?> E‑Manager Nepal. All rights reserved.</div>
        </div>
        </footer>
    </body>
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/welcome.blade.php ENDPATH**/ ?>