...
<?php $__env->startSection('page-subtitle', 'Manage your product catalog'); ?>
...
<div class="row mb-4">
    <div class="col-md-6">
        <div class="search-box">
            ...
            <input type="text" placeholder="Search products..." id="product-search" value="<?php echo e(request('search')); ?>">
        </div>
    </div>
    <div class="col-md-6 text-end">
        ...
        <a href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-primary ms-2">
...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Products (<?php echo e($products->total()); ?>)</h5>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr data-product-id="<?php echo e($product->id); ?>">
                        ...
                        <td>
                            <div class="product-image">
                                <?php if($product->primary_image_url): ?>
                                    <img src="<?php echo e($product->primary_image_url); ?>" alt="<?php echo e($product->name); ?>" class="img-fluid rounded">
                                <?php else: ?>
                                ...
                                <?php if(is_array($product->images) && count($product->images) > 1): ?>
                                    <div class="image-count-badge">
                                        ...
                                        <?php echo e(count($product->images)); ?>
                        ...
                        <td>
                            <div class="product-info">
                                <h6 class="product-name">
                                    <a href="<?php echo e(route('admin.products.show', $product->id)); ?>" class="text-decoration-none">
                        ...
                        <td>
                            <code><?php echo e($product->sku ?? 'N/A'); ?></code>
                        </td>
                        <td>
                            <div class="price-info">
                                <div class="current-price">Rs. <?php echo e(number_format($product->sale_price ?? $product->price, 2)); ?></div>
                                <?php if($product->sale_price && $product->sale_price < $product->price): ?>
                                    <small class="original-price">Rs. <?php echo e(number_format($product->price, 2)); ?></small>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td>
                            <div class="stock-info">
                                <?php if($product->track_inventory): ?>
                                    <span class="stock-quantity"><?php echo e($product->stock_quantity ?? 0); ?></span>
                        ...
                        <td>
                            <small class="text-muted"><?php echo e($product->created_at->format('M j, Y')); ?></small>
                        </td>
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <button type="button" class="btn btn-outline-info duplicate-product" 
                                        data-product-id="<?php echo e($product->id); ?>" title="Duplicate">
                                    <i class="fas fa-copy"></i>
                                </button>
                                <button type="button" class="btn btn-outline-danger delete-product" 
                                        data-product-id="<?php echo e($product->id); ?>" title="Delete">
...
function toggleProductStatus(toggle) {
    ...
    AjaxHelper.put(`<?php echo e(url('admin/products')); ?>/${productId}/toggle-status`, {
        is_active: isActive
    })
    .then(response => {
...
function duplicateProduct(productId) {
    ...
    AjaxHelper.post(`<?php echo e(url('admin/products')); ?>/${productId}/duplicate`)
    .then(response => {
        if (response.success !== false) {
...
function deleteProduct(productId) {
    ...
    AjaxHelper.delete(`<?php echo e(url('admin/products')); ?>/${productId}`)
    .then(response => {
...
function performBulkAction(action) {
    ...
    AjaxHelper.post('<?php echo e(route("admin.products.bulk-action")); ?>', {
        action: action,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/products/index.blade.php ENDPATH**/ ?>