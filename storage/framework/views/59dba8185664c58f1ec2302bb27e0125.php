<?php $__env->startSection('title', 'Bulk Order Creation'); ?>
<?php $__env->startSection('page-title', 'Bulk Order Creation'); ?>
...
<div class="container-fluid">
    <div class="bulk-order-container">
        ...
        <div class="alert alert-warning mt-3">
            ...
            Please <a href="<?php echo e(route('admin.products.create')); ?>" class="alert-link">create at least one active product</a> before creating bulk orders.
        </div>
        <?php endif; ?>
                                    ...
                                    <div class="product-row">
                                        <select name="orders[1][products][0][id]" 
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($product->id); ?>"><?php echo e($product->name); ?> - Rs. <?php echo e(number_format($product->sale_price ?? $product->price, 0)); ?></option>
...
?>
const products = <?php echo json_encode($productsArray, 15, 512) ?>;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("admin.pending-orders.store-bulk")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/pending-orders/create-bulk.blade.php ENDPATH**/ ?>