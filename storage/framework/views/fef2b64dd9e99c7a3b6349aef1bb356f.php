...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center">
                <p class="mb-0">Don't have an account? 
                    <a href="<?php echo e(route('vendor.register')); ?>" class="register-link">Register here</a>
                </p>
            </div>

            <div class="text-center mt-3">
                <a href="<?php echo e(route('super.login')); ?>" class="text-muted small">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/vendor/auth/login.blade.php ENDPATH**/ ?>