            ...
            <div class="settings-container">
                <div class="page-header">
                    ...
                    <div class="quick-actions">
                        <form action="<?php echo e(route('admin.settings.clear-cache')); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="action-btn secondary">
                                <i class="fas fa-broom"></i> Clear Cache
                            </button>
                        </form>
                        <form action="<?php echo e(route('admin.settings.optimize')); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
                ...
                <div class="settings-grid">
                    <!-- General Settings -->
                    <a href="<?php echo e(route('admin.settings.general')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['general']->count()); ?> settings
                        </span>
                    </a>

                    <!-- Email Settings -->
                    <a href="<?php echo e(route('admin.settings.email')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['email']->count()); ?> settings
                        </span>
                    </a>

                    <!-- Payment Settings -->
                    <a href="<?php echo e(route('admin.settings.payment')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['payment']->count()); ?> settings
                        </span>
                    </a>

                    <!-- Notification Settings -->
                    <a href="<?php echo e(route('admin.settings.notification')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['notification']->count()); ?> settings
                        </span>
                    </a>

                    <!-- Shipping Settings -->
                    <a href="<?php echo e(route('admin.settings.shipping')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['shipping']->count()); ?> settings
                        </span>
                    </a>

                    <!-- Tax & Currency -->
                    <a href="<?php echo e(route('admin.settings.tax')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['tax']->count()); ?> settings
                        </span>
                    </a>

                    <!-- Order Settings -->
                    <a href="<?php echo e(route('admin.settings.order')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['order']->count()); ?> settings
                        </span>
                    </a>

                    <!-- Security Settings -->
                    <a href="<?php echo e(route('admin.settings.security')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['security']->count()); ?> settings
                        </span>
                    </a>

                    <!-- API Configuration -->
                    <a href="<?php echo e(route('admin.settings.api')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['api']->count()); ?> settings
                        </span>
                    </a>

                    <!-- System Settings -->
                    <a href="<?php echo e(route('admin.settings.system')); ?>" class="setting-card">
                        ...
                        <span class="setting-count">
                            <i class="fas fa-cog"></i> <?php echo e($settingsGroups['system']->count()); ?> settings
                        </span>
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>