...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - Delivery Boy Portal</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <h3><?php echo e(Auth::guard('delivery_boy')->user()->name ?? 'Delivery Boy'); ?></h3>
            <p><?php echo e(Auth::guard('delivery_boy')->user()->email ?? ''); ?></p>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li style="margin-top: 2rem; padding: 0 1.5rem;">
                <form action="<?php echo e(route('delivery-boy.logout')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
    ...
    <div class="main-content">
        ...
        <div class="top-nav">
            ...
            <div class="user-section">
                <div>
                    <strong><?php echo e(Auth::guard('delivery_boy')->user()->name ?? 'Delivery Boy'); ?></strong>
                    <p class="mb-0 text-muted" style="font-size: 0.85rem;">Delivery Partner</p>
                </div>
                <div class="user-avatar">
                    <?php echo e(substr(Auth::guard('delivery_boy')->user()->name ?? 'D', 0, 1)); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/delivery-boy/layout.blade.php ENDPATH**/ ?>