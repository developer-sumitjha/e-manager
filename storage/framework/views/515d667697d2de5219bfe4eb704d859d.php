...
<div class="purchases-header">
    ...
    <a href="<?php echo e(route('admin.accounting.purchases.create')); ?>" class="add-purchase-btn">
...
<div class="purchases-summary">
    <div class="summary-card">
        ...
        <div class="summary-value">₹<?php echo e(number_format($purchases->sum('amount'), 2)); ?></div>
    ...
    <div class="summary-card">
        ...
        <div class="summary-value"><?php echo e($purchases->count()); ?></div>
    ...
    <div class="summary-card">
        ...
        <div class="summary-value">₹<?php echo e($purchases->count() > 0 ? number_format($purchases->avg('amount'), 2) : '0.00'); ?></div>
    ...
    <div class="summary-card">
        ...
        <div class="summary-value">₹<?php echo e(number_format($purchases->where('created_at', '>=', now()->startOfMonth())->sum('amount'), 2)); ?></div>
...
<div class="filters-bar">
    <div class="search-box">
        ...
        <input type="text" id="purchases-search" class="form-control" placeholder="Search purchases..." value="<?php echo e(request('search')); ?>">
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="purchase-id">#<?php echo e($purchase->id); ?></div>
                    </td>
                    <td>
                        <div class="account-name"><?php echo e($purchase->account->name); ?></div>
                    </td>
                    <td>
                        <div class="description-text" title="<?php echo e($purchase->description); ?>">
                            <?php echo e($purchase->description); ?>

                        </div>
                    </td>
                    <td>
                        <div class="amount-value">₹<?php echo e(number_format($purchase->amount, 2)); ?></div>
                    </td>
                    <td>
                        <div class="reference-number"><?php echo e($purchase->reference ?? 'N/A'); ?></div>
                    </td>
                    <td>
                        <div class="purchase-date"><?php echo e($purchase->transaction_date->format('M d, Y')); ?></div>
                    </td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('admin.accounting.purchases.edit', $purchase->id)); ?>" class="action-btn edit">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <button type="button" class="action-btn delete" onclick="deletePurchase(<?php echo e($purchase->id); ?>)">
...
<script>
    ...
    function applyFilters() {
        ...
        window.location.href = `<?php echo e(route('admin.accounting.purchases')); ?>?${params.toString()}`;
    }
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/e-manager/resources/views/admin/accounting/purchases.blade.php ENDPATH**/ ?>